...
- [ ] 1.1. Create database migration for media_files table
...
- [ ] 1.2. Create MediaFile model interfaces and types
...
- [ ] 1.3. Export MediaFile model in models index
...
- [ ] 2.1. Create UUIDExtractor utility
...
- [ ] 2.2. Create MetadataReader utility
...
- [ ] 2.3. Add UUID validation to validation utilities
...
- [ ] 2.4. Export utility functions in utils index
...
- [ ] 3.1. Create MediaLoaderService with configuration
...
- [ ] 3.2. Implement MediaLoaderService core loading logic
...
- [ ] 3.3. Add batch processing and transactions to MediaLoaderService
...
- [ ] 3.4. Implement idempotency in MediaLoaderService
...
- [ ] 3.5. Export MediaLoaderService in services index
...
- [ ] 4.1. Create CLI directory and command script
...
- [ ] 4.2. Add CLI output formatting and reporting
...
- [ ] 4.3. Add package.json script for CLI command
...
- [ ] 5.1. Create unit tests for UUIDExtractor
...
- [ ] 5.2. Create unit tests for MetadataReader
...
- [ ] 5.3. Create unit tests for MediaLoaderService
